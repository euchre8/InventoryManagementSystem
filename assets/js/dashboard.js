...
$(document).ready(function() {
  ...
  if ($('.navbar[color-on-scroll]').length != 0) {
    Dashboard.checkScrollForTransparentNavbar();
    $(window).on('scroll', Dashboard.checkScrollForTransparentNavbar)
  }
...
$(document).on('click', '.navbar-toggle', function() {
  ...
  if (Dashboard.misc.navbar_menu_visible == 1) {
    ...
    Dashboard.misc.navbar_menu_visible = 1;
  }
});
